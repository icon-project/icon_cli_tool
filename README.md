...
You need Python3.6 or later to run icxcli. You can have multiple Python versions (2.x and 3.x) installed on the same system without problems. 

On OS X and Ubuntu 16.04 for example the necessary packages are:
- automake
- pkg-config
- virtualenv
- autoconf
...
In Ubuntu16.04, you can install Python3.6 like this:
```shell
...
You can install pip3 for python3.6 like this:
...
You can install autoconf, libtool and automake for python3.6 like this:
```shell
